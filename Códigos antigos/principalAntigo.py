...
cv2.imshow('DEPOIS', mascara)
cv2.waitKey(0)
cv2.destroyAllWindows()

rotulos = labeling.contar(altura, largura,
                          mascara)  # Contar | Percorre cada pixel e armazena o rotulo de cada um se não for background ou se não for um rótulo previamente percorrido.
...
caracteristicas.encontrarCaracteristicas(altura, largura, mascara, rotulos, objetos, imagemColorida,mascaraCinza, modelo_objeto)
